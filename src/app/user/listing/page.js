        ...
        <div className="flex justify-between items-center mb-10">
          ...
          <div className="flex items-center space-x-4 bg-[#2D0B5A] p-3 px-6 rounded-2xl border border-white/5 shadow-xl">
            <div className="text-right">
              ...
              <p className="text-[10px] font-mono text-[#FFB300]">
                {userData.address}
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-72 space-y-6">
            <div className="bg-[#2D0B5A] rounded-3xl p-6 border border-white/5 shadow-xl">
              <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#E91E63] mb-6">
                User Profile
              </h3>
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div>
                  <p className="text-[10px] font-mono text-slate-500 truncate w-48 mx-auto">
                    {userData.address}
                  </p>
            ...
            <div className="bg-gradient-to-br from-[#E91E63]/20 to-transparent rounded-3xl p-6 border border-[#E91E63]/20">
              ...
              <p className="text-[10px] text-slate-400 leading-relaxed italic">
                Ensure you have enough gas fees (ETH) in your wallet to complete
                the minting process.
              </p>
            </div>
          </div>
              ...
              <form className="space-y-8">
                ...
                <div className="group relative border-2 border-dashed border-white/10 rounded-3xl p-12 text-center hover:border-[#E91E63] transition-all duration-500 bg-[#1A0533]/30 cursor-pointer">
                  ...
                  <p className="text-[10px] text-slate-500 mt-2 italic text-center">
                    Images will be pinned to IPFS network
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <label className="text-[9px] font-black uppercase tracking-widest text-slate-500 block mb-2 ml-1">
                        Item Name
                      </label>
                      <input
                        type="text"
                        placeholder="e.g. Skyline R34 STH"
                        className="w-full bg-[#1A0533] border border-white/5 rounded-2xl p-4 text-sm focus:outline-none focus:border-[#E91E63] transition-all"
                      />
                    </div>
                    <div>
                      <label className="text-[9px] font-black uppercase tracking-widest text-slate-500 block mb-2 ml-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          step="0.01"
                          placeholder="0.00"
                          className="w-full bg-[#1A0533] border border-white/5 rounded-2xl p-4 pl-10 text-sm focus:outline-none focus:border-[#FFB300] font-mono"
                        />
                      </div>
                    </div>
                    <div>
                      ...
                      <textarea
                        rows="3"
                        placeholder="Explain the card and blister condition..."
                        className="w-full bg-[#1A0533] border border-white/5 rounded-2xl p-4 text-sm focus:outline-none focus:border-[#E91E63] italic"
                      ></textarea>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <input
                        type="text"
                        placeholder="Brand"
                        className="bg-[#1A0533] border border-white/5 rounded-xl p-3 text-xs focus:outline-none focus:border-[#E91E63]"
                      />
                      <input
                        type="text"
                        placeholder="Year"
                    ...
                    <input
                      ...
                      className="w-full bg-[#1A0533] border border-white/5 rounded-xl p-3 text-xs focus:outline-none focus:border-[#E91E63]"
                    />
                    <input
                      type="text"
                ...
                <div className="pt-6 border-t border-white/5">
                  <button
                    type="button"
                    className="w-full py-6 rounded-3xl bg-[#FFB300] text-[#1A0533] font-black uppercase italic tracking-[0.2em] transition-all hover:scale-[1.02] shadow-2xl shadow-[#FFB300]/20 flex items-center justify-center group"
                  >
