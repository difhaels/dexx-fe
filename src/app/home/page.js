...
const products = [
  ...
  },
  {
    ...
    rating: 5.0,
    sellerRating: 4.8,
    image: "https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?q=80&w=300&h=200&fit=crop",
  },
  {
    id: 5,
    ...
    rating: 4.9,
    sellerRating: 4.9,
    image: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=300&h=200&fit=crop",
  },
];
      ...
      <main className="container mx-auto p-4 md:p-8">
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-400 text-sm">Peer-to-Peer Trading Secured by Smart Contracts</p>
          </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between border-t border-white/5 pt-3">
                  ...
                  <div className="text-[10px] text-slate-500 uppercase font-bold tracking-tighter">
                    Seller: <span className="text-slate-300">{product.sellerRating}</span>
                  </div>
                </div>
              </div>
            </div>
