    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-gray-800 text-white p-6 min-h-screen">
        ...
        <nav>
          <ul>
            <li className="mb-4">
              <Link href="/seller/dashboard" className={`flex items-center p-3 rounded-lg transition-colors text-gray-400 hover:bg-gray-700`}>
                <FaHome className="mr-3 text-lg" />
                <span className="font-semibold">Home</span>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/seller/orders" className={`flex items-center p-3 rounded-lg transition-colors ${activeSidebarTab === "orders" ? "bg-gray-700 text-white" : "text-gray-400 hover:bg-gray-700"}`}>
                <FaShoppingBag className="mr-3 text-lg" />
                <span className="font-semibold">Orders</span>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/seller/products" className={`flex items-center p-3 rounded-lg transition-colors text-gray-400 hover:bg-gray-700`}>
